	 ...
	 */
        ...
        _generateHTML: function(inst) {
            ...
            var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                ...
                ' title="' + prevText + '">' + (isRTL ? '<i class="icon md-chevron-right"></i>' : '<i class="icon md-chevron-left"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="'+ prevText +'">' + (isRTL ? '<i class="icon md-chevron-right"></i>' : '<i class="icon md-chevron-left"></i>') + '</a>'));
            ...
            var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                ...
                ' title="' + nextText + '">' + (isRTL ? '<i class="icon md-chevron-left"></i>' : '<i class="icon md-chevron-right"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="'+ nextText + '">' + (isRTL ? '<i class="icon md-chevron-left"></i>' : '<i class="icon md-chevron-right"></i>') + '</a>'));
        ...
        _generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
            ...
            if (secondary || !changeMonth)
                ...
                monthHtml += '<div class="form-group form-material" data-plugin="formMaterial" style="float:right; width: 50%;">' +
                    '<select class="ui-datepicker-month form-control" data-handler="selectMonth" data-event="change" style="width: 90%; font-weight:normal">';
            ...
            if ( !inst.yearshtml ) {
                ...
                if (secondary || !changeYear)
                    ...
                    inst.yearshtml += '<div class="form-group form-material" data-plugin="formMaterial" style="float:right; width:50%; ">' +
                        '<select class="ui-datepicker-year form-control"   data-handler="selectYear" data-event="change" style=" width: 100%; font-weight:normal">';
                    for (; year <= endYear; year++) {
                        inst.yearshtml += '<option value="' + year + '"' +
                        (year == drawYear ? ' selected="selected"' : '') +
                        '>' + year + '</option>';
                    }
                    inst.yearshtml += '</select></div>';
